...
- Samardzhiev, K.; Fleischmann, M.; Arribas-Bel, D.; Calafiore, A.; Rowe, F. (2022). “Functional signatures in Great Britain: A dataset”. Data in Brief, 43. <https://doi.org/10.1016/j.dib.2022.108335> [`[Blog post]`](blog/post28_dib_paper.md)
- Singleton, A.; Arribas-Bel, D.; Murray, J.; Fleischmann, M. (2022). “Estimating generalized measures of local neighbourhood context from multispectral satellite images using a convolutional neural network”. Computers, Environment and Urban Systems, 95. <https://doi.org/10.1016/j.compenvurbsys.2022.101802> [`[Blog post]`](blog/post25_ceus_paper.md)
